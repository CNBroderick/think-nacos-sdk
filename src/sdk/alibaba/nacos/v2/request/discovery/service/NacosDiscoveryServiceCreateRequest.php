 ...
 * @see https://nacos.io/zh-cn/docs/open-api.html 服务发现->创建服务
 */
class NacosDiscoveryServiceCreateRequest extends AbstractNacosRequest
{
     ...
     * @return $this
     */
    public function paramGroupName(string $groupName): NacosDiscoveryServiceCreateRequest
    {
     ...
     * @return $this
     */
    public function paramNamespaceId(string $namespaceId): NacosDiscoveryServiceCreateRequest{
     ...
     * @return $this
     */
    public function paramProtectThreshold(float $protectThreshold): NacosDiscoveryServiceCreateRequest{
     ...
     * @return $this
     */
    public function paramMetadata(string $metadata): NacosDiscoveryServiceCreateRequest
    {
     ...
     * @return $this
     */
    public function paramSelector(string $selector): NacosDiscoveryServiceCreateRequest {
