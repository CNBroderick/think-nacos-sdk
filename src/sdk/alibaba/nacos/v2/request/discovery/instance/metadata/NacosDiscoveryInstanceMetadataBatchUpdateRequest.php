 ...
 * @see https://nacos.io/zh-cn/docs/open-api.html 服务发现->批量更新实例元数据(Beta)
 */
class NacosDiscoveryInstanceMetadataBatchUpdateRequest extends AbstractNacosRequest
{
     ...
     * @return $this
     */
    public function paramInstances(string $instances): NacosDiscoveryInstanceMetadataBatchUpdateRequest
    {
